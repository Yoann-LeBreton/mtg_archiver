...
import 'package:mtg_archiver/features/cards/presentation/widgets/back_to_top_widget.dart';
import 'package:mtg_archiver/features/cards/presentation/widgets/card_list_item_widget.dart';
...
class CardListWidget extends StatefulWidget {
  ...
  final Function(String cardId, String cardName) onCardClick;
              ...
              SliverPadding(
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    ...
                    (BuildContext context, int index) => CardListItemWidget(
                      card: widget.cards[index],
                      onDetailsClick: () => widget.onCardClick(
